...
export default function Home() {
  return (
    <div>
      ...
      {/* White section below */}
      <div className="w-full bg-white mt-20 px-6">

        {/* First flex container w/ two columns */}
        <div className="flex flex-col md:flex-row items-center md:items-start gap-20 max-w-6xl mx-auto my-auto">
        ...
        <div className="flex flex-col md:flex-row items-center md:items-start py-20 gap-20 max-w-6xl mx-auto">
          ...
          <div className={`md:w-1/2 text-left order-1 md:order-2 ${slabo.className}`}>
            ...
            <p className="text-lg md:text-2xl mt-5 font-bold text-center dark:text-black">
              Phone: +1 (860) 573-9952
            </p>

            <p className="text-lg md:text-2xl mt-5 font-bold text-center dark:text-black">
              Email: relentlesswrapsct@gmail.com
            </p>

            <p className="text-lg md:text-2xl mt-5 font-bold text-center dark:text-black">
              Social Media Tag: @relentlesswrapsct
            </p>
          </div>
